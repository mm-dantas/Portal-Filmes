                    ...
                    <div className="relative z-10 p-4 flex flex-col justify-between h-[500px] ">
                        ...
                        <div className="flex gap-5">
                            ...
                            >
                                {watchLater ? (
                                    <img
                                        src={ImgeRemoverSalvar}
                                        alt="Ícone de remover dos salvos"
                                        className="h-10"
                                        title="Remover do assistir depois"
                                    />
                                ) : (
                                    <img
                                        src={ImgSalvar}
                                        alt="Ícone de salvar"
                                        className="h-10"
                                        title="Adicionar ao assistir depois"
                                    />
                                )}
                            </button>
                            ...
                            >
                                {assistido ? (
                                    <img src={ImgAssistido} 
                                    alt="Ícone de remover dos assistido" 
                                    className="h-10"
                                    title="Remover dos assistidos"
                                    />

                                ) : (
                                    <img src={ImgNaoAssistido} 
                                    alt="Ícone adicionar aos assistidos" 
                                    className="h-10" 
